...
The project utilizes data sourced from 'https://onionbicokr-my.sharepoint.com/:x:/g/personal/ken_lee_onionbi_co_kr/EQbM0JWYU7xGjKd3U3CPmgIBnDSg6myZVGHSlXaOcAPWXA?e=ZGPqe2' and PostgreSQL (queried via pgAdmin 4).
